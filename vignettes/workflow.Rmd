...
```{r pressure, echo=FALSE, fig.cap="SentiAnalyzer", out.width = '10%',fig.align="Right",eval=FALSE,include=FALSE}
knitr::include_graphics("../inst/extdata/SAhexlogo.png")
```


### Sentiment analysis for consumer review

SentiAnalyzer is a "one-stop" solution for analysis of of consumer reviews which includes natural language processing (NLP) of consumer sentiments. The dataset that SentiAnalyzer can work with, for now, is a short text and a binary quantification, e.g. whether consumer hits the like button. The NLP of the sentiment is analyzed through  options of algorithms to compile the words and the machinge learning training model of choice.  
...
## Comparison function; Comparison of ML training models
